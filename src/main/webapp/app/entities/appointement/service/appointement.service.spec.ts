...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../appointement.test-samples';

import { AppointementService } from './appointement.service';

const requireRestSample: IAppointement = {
